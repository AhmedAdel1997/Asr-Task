...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/background_bg.png
  AssetGenImage get backgroundBg =>
      const AssetGenImage('assets/images/background_bg.png');
  ...
  /// File path: assets/images/deleted.png
  AssetGenImage get deleted => const AssetGenImage('assets/images/deleted.png');

  /// File path: assets/images/first_bg.png
  AssetGenImage get firstBg =>
      const AssetGenImage('assets/images/first_bg.png');

  /// File path: assets/images/formal_photo_cropped.png
  AssetGenImage get formalPhotoCropped =>
      const AssetGenImage('assets/images/formal_photo_cropped.png');
  ...
  /// File path: assets/images/second_bg.png
